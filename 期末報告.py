"print(\"哈囉!你好,這邊是幫你選擇三餐機器人，我是早餐機器人，很高興認識你\")\r\n", 
        ...
        "if answer== \"卡拉雞\":\r\n", 
        "  print(\"那今天就吃卡拉雞腿堡吧!麥當勞歡迎你\")\r\n",  
        "elif answer == \"嫩切雞\" :\r\n", 
        "  print(\"那今天就吃嫩切雞腿堡吧!麥當勞歡迎你\")\r\n",  
        "elif answer == \"里肌\" :\r\n",  
        ...
        "  if answer== \"蛋餅\":\r\n",    
        "    print(\"早餐店就是要吃蛋餅阿\")\r\n",    
        "    answer = input(\"那妳喜歡甚麼口味的呢?玉米，起司，肉鬆\")\r\n",  
        "    if answer== \"玉米\":\r\n",  
        "      print(\"好選擇!我的必點名單!那今天就吃玉米蛋餅吧!\")\r\n",  
        "    elif answer == \"肉鬆\" :\r\n",  
        "      print(\"好選擇!融化起司最對味!那今天就吃肉鬆蛋餅吧!\")\r\n", 
        "    elif answer == \"起司\" :\r\n",  
        "      print(\"好選擇!早餐店必吃!那今天就吃起司蛋餅吧!\")\r\n",   
        "  if answer== \"其他炸物\":\r\n",  
        "    print(\"有夠不健康\")\r\n", 
        "    answer = input(\"那這三樣中挑一個你最喜歡的!蛋塔，薯條，雞塊\")\r\n",   
        "    if answer== \"薯餅\":\r\n",  
        "      print(\"那今天就吃蛋塔吧!但還是不要太常吃炸的喔!\")\r\n",   
        "    elif answer == \"薯條\" :\r\n",  
